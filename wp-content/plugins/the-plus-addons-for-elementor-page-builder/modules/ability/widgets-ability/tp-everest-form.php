...
wp_register_ability('tpae/tpae-everest-form', [
    ...
    'input_schema' => [
        ...
        'properties' => [
            ...
            'everest_form' => ['type' => 'string', 'description' => 'Everest Forms form ID to embed (values are site-specific; read the live list with the tpae/tpae-widget-schema ability)'],
