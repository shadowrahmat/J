...
wp_register_ability('tpae/tpae-ninja-form', [
    ...
    'input_schema' => [
        ...
        'properties' => [
            ...
            'contact_form' => ['type' => 'string', 'description' => 'Ninja Forms form ID to embed (values are site-specific; read the live list with the tpae/tpae-widget-schema ability)'],
