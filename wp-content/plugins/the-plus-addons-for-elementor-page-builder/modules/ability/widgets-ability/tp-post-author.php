...
wp_register_ability('tpae/tpae-post-author', [
    'label' => __('Post Author', 'tpebl'),
    'description' => __('Adds the The Plus "Post Author" widget (tp-post-author) to an Elementor container.', 'tpebl'),
    'category' => 'tpae',
    'input_schema' => [
        'type' => 'object',
        'properties' => [
            ...
            'style' => [
                ...
                'description' => 'Author box display style',
            ],
    ...
    'execute_callback' => 'tpae_mcp_add_theplus_post_author_ability',
    'permission_callback' => 'tpae_mcp_add_theplus_post_author_permission',
    'meta' => [
        'show_in_rest' => true,
 ...
 */
function tpae_mcp_add_theplus_post_author_permission(?array $input = null): bool
{
...
/**
 * Add a TP Post Author widget into an Elementor container.
 *
 * @param array<string, mixed> $input
 * @return array<string, mixed>|WP_Error
 */
function tpae_mcp_add_theplus_post_author_ability(array $input)
{
    if (!tpae_mcp_has_elementor()) {
        return new WP_Error('elementor_missing', __('Elementor must be active.', 'tpebl'));
    }

    $widget_type = 'tp-post-author';
    if (!tpae_mcp_has_registered_widget($widget_type)) {
        return new WP_Error('widget_missing', __('The Plus Post Author widget is not registered on this site.', 'tpebl'));
    }
