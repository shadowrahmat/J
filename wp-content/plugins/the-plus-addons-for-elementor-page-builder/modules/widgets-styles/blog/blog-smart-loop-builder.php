...
$template = str_replace( '{{tpae_author_meta}}', esc_html( get_the_author_meta( 'display_name' ) ), $template );
$template = str_replace( '{{tpae_author_url}}', esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ), $template );
